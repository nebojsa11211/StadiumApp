...
/// <summary>
/// Customer implementation of secure API service that wraps the existing ApiService
/// </summary>
public class CustomerSecureApiService : ISecureApiService
{
    ...
    public CustomerSecureApiService(
