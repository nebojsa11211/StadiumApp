...
public class SignalRService : ISignalRService
{
    ...
    public SignalRService(IStaffApiService apiService, IConfiguration configuration)
    {
    ...
    public async Task JoinStaffHub()
    {
        if (_hubConnection != null && IsConnected)
        {
            await _hubConnection.InvokeAsync("JoinStaffHub");
        }
    }

    public async Task LeaveStaffHub()
    {
        if (_hubConnection != null && IsConnected)
        {
            await _hubConnection.InvokeAsync("LeaveStaffHub");
        }
    }
