...
/// <summary>
/// Customer-specific implementation of the unified token storage service
/// </summary>
public class CustomerTokenStorageService : ITokenStorageService, ICustomerTokenStorageService
{
    ...
    public string ApplicationContext => AuthenticationConstants.ApplicationContexts.Customer;
    ...
    public CustomerTokenStorageService(IJSRuntime jsRuntime)
    {
    ...
    public async Task StoreTokenAsync(string token, DateTime? expiresAt = null, string? userEmail = null)
    {
        ...
        try
        {
            await _jsRuntime.InvokeVoidAsync("localStorage.setItem",
                AuthenticationConstants.StorageKeys.Customer.Token, token);

            if (expiresAt.HasValue)
            {
                await _jsRuntime.InvokeVoidAsync("localStorage.setItem",
                    AuthenticationConstants.StorageKeys.Customer.TokenExpiration,
            ...
            {
                await _jsRuntime.InvokeVoidAsync("localStorage.setItem",
                    AuthenticationConstants.StorageKeys.Customer.Email, userEmail);
            }
        }
        catch (Exception)
        {
    ...
    public async Task<string?> GetTokenAsync()
    {
        ...
        try
        {
            var storedToken = await _jsRuntime.InvokeAsync<string?>("localStorage.getItem",
                AuthenticationConstants.StorageKeys.Customer.Token);
    ...
    public async Task<TokenInfo?> GetTokenInfoAsync()
    {
        ...
        try
        {
            ...
            var userEmail = await _jsRuntime.InvokeAsync<string?>("localStorage.getItem",
                AuthenticationConstants.StorageKeys.Customer.Email);
    ...
    public async Task ClearTokenAsync()
    {
        ...
        try
        {
            ...
            await _jsRuntime.InvokeVoidAsync("localStorage.removeItem",
                AuthenticationConstants.StorageKeys.Customer.Email);
            await _jsRuntime.InvokeVoidAsync("localStorage.removeItem",
                AuthenticationConstants.StorageKeys.Customer.RefreshToken);
            await _jsRuntime.InvokeVoidAsync("localStorage.removeItem",
                AuthenticationConstants.StorageKeys.Customer.RefreshTokenExpiration);
            await _jsRuntime.InvokeVoidAsync("localStorage.removeItem",
                AuthenticationConstants.StorageKeys.Customer.UserData);
        }
        catch (Exception)
        {
    ...
    public async Task StoreUserDataAsync(string key, string value)
    {
        ...
        var userDataKey = $"{AuthenticationConstants.StorageKeys.Customer.UserData}_{key}";
    ...
    public async Task ClearUserDataAsync()
    {
        try
        {
            ...
            var userDataPrefix = AuthenticationConstants.StorageKeys.Customer.UserData;
    ...
    public async Task StoreRefreshTokenAsync(string refreshToken, DateTime? expiresAt = null)
    {
        ...
        {
            await _jsRuntime.InvokeVoidAsync("localStorage.setItem",
                AuthenticationConstants.StorageKeys.Customer.RefreshToken, refreshToken);
    ...
    public async Task<string?> GetRefreshTokenAsync()
    {
        ...
        try
        {
            var storedRefreshToken = await _jsRuntime.InvokeAsync<string?>(
                "localStorage.getItem", AuthenticationConstants.StorageKeys.Customer.RefreshToken);
    ...
    public async Task<bool> IsRefreshTokenValidAsync()
    {
        ...
        try
        {
            var expirationStr = await _jsRuntime.InvokeAsync<string?>(
                "localStorage.getItem", AuthenticationConstants.StorageKeys.Customer.RefreshTokenExpiration);
